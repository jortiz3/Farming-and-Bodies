...
public class ShopScript : MonoBehaviour
{
	...
	{
		shopGroup.FindChild("Info").GetComponent<Text>().text = "Your Money: " + global.playerInventory.money;
	}
	...
	public void SellItem(GameObject uiObj)
	{
		...
		Item temp = global.playerInventory.SellItem (uiObj, 1);
		if (temp == null)
		{
